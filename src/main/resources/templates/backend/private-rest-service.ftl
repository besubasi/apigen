...
<#assign FEIGN_CLIENT_PATH = '{application.module.logistic.${model.microServiceName}.services.${model.apiPackage}.${model.apiName?uncap_first}.path}'>
<#assign FEIGN_CLIENT_URL = '{application.module.logistic.${model.microServiceName}.services.${model.apiPackage}.${model.apiName?uncap_first}.url}'>
