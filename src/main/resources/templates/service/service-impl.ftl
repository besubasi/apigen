...
import ${conf.servicePackage}.${model.apiPackage}.repository.${model.apiName}RepositoryImpl;
import ${conf.servicePackage}.common.service.BaseServiceImpl;

<#assign TAG_MODEL_SEARCH_MODEL_AND_ENTITY = '<${model.apiName}Model, ${model.apiName}SearchModel, ${model.apiName}Entity, ${model.apiName}RepositoryImpl, ${model.apiName}Converter>'>
@Service
public class ${model.apiName}ServiceImpl extends BaseServiceImpl${TAG_MODEL_SEARCH_MODEL_AND_ENTITY} implements ${model.apiName}Service {
    ...
    public ${model.apiName}ServiceImpl(${model.apiName}RepositoryImpl repository, ${model.apiName}Converter converter) {
