...
public interface PathConstant {
    ...
    String PRODUCTION_MENU_CHANGELOG_PATH = "/hvl-kovan-logistic/modules/production-management/service/src/main/resources/db/changelog/logistic/production/db.changelog-production-system-2.1.xml";
    String PRODUCTION_OAUTH_CHANGELOG_PATH = "/hvl-kovan-logistic/modules/production-management/service/src/main/resources/db/changelog/logistic/production/db.changelog-production-oauth-2.1.xml";
